...
def run_nas(proj_path, datayaml_path, data=None, target=None, train_mode='search', final_arch=None):
    ...
    from model import ConcatEntirePathNeck
    from model import SearchNeck
    from model import SearchSpaceWrap
    if args.train_mode == 'retrain':
    ...
    # --------- execute -------------------------------------------------------
    from evaluator import ConcatBasedNetTrainer
    from evaluator import ConcatEntirePathTrainer
