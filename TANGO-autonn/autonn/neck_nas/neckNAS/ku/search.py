...
from nni.retiarii.oneshot.pytorch.utils import replace_input_choice
from nni.retiarii.oneshot.pytorch.utils import replace_layer_choice
from tqdm import tqdm

from .model import SearchYolov4
from .syolo_utils.general import check_anchors
from .syolo_utils.general import fitness
from .syolo_utils.general import labels_to_class_weights
from .syolo_utils.general import labels_to_image_weights
from .syolo_utils.general import plot_images
from .syolo_utils.general import plot_labels
from .syolo_utils.general import plot_results
from .syolo_utils.general import strip_optimizer
from .syolo_utils.torch_utils import ModelEMA
from .syolo_utils.torch_utils import init_seeds
from .syolo_utils.torch_utils import intersect_dicts
from .syolo_utils.torch_utils import is_parallel
    ...
    def fit(self):
        ...
        if self.rank in [-1, 0]:
            ...
            fresults, flast, fbest = \
                f'results{n}.txt', self.wdir + f'last{n}.pt', \
