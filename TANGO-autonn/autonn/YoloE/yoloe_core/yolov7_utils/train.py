...
def run_yolo(
    ...
    if basemodel_yaml["imgsz"] == 1280:
        return run_yolo_aux(
            proj_path, dataset_yaml_path, data, target, train_mode, final_arch
        )
    ...
    opt.hyp = (
        ...
        / "data"
        / f"hyp.scratch.{basemodel_yaml['hyp']}.yaml"
    )
    ...
    opt.batch_size = int(
        proj_info["batchsize"] / 4
    )  ## TODO: Something is wrong. AutoBatch divided by 4 is good for training.
