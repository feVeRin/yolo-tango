...
from ofa_utils import MyGlobalAvgPool2d
...
from ofa_utils.layers import ResidualBlock
from ofa_utils.layers import set_layer_from_config

## search_block.py
from .search_block import BBoneELAN
from .search_block import DyConv
from .search_block import HeadELAN
from .search_block import TinyDyConv
from .search_block import TinyELAN
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cfg", type=str, default="./yaml/yolov7_elan_test.yml", help="model.yaml"
    )
    parser.add_argument(
